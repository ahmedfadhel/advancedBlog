...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('perm_selected')){
            $role->syncPermissions($request->perm_selected);
        }
        // Session::flush('success','Successfully updated the' . $role->display_name . ' in the database.' );
